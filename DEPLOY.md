...
| let someone found their own fort | founder: Workshop → SAPLINGS → grow one; say the code to exactly one person. they plant it at treefort.lol → "i have a sapling". the nursery grows ONE sapling per day (max 5 unplanted; compost frees space, never time), and a NEWBORN fort cannot grow any for its first day — no fort→sapling→fort daisy-chains |
